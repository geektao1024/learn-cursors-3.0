...
サイト本体ができたあとでも、公開時にはデモ動画、ヒーロー背景の音、SNS 配信用の短い素材などを用意したくなることがあります。そうした制作フローも視野に入れるなら、[ビルダー向けおすすめリソース](/ja/resources/) も見ておくと便利です。中で紹介している [Musikalis](https://musikalis.com/) は、ランディングページ、製品デモ、ブランド向け動画に使う AI 生成音源を探す場面と相性があります。
