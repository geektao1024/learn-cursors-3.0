...
export default defineConfig({
  ...
  cleanUrls: false,
  rewrites: {
    'blog/posts/:post.md': 'blog/posts/:post',
    'blog/posts/:post.html': 'blog/posts/:post',
    'en/blog/posts/:post.md': 'en/blog/posts/:post',
    'en/blog/posts/:post.html': 'en/blog/posts/:post',
    'ja/blog/posts/:post.md': 'ja/blog/posts/:post',
    'ja/blog/posts/:post.html': 'ja/blog/posts/:post',
    'docs-zh/:section/:page.md': 'docs-zh/:section/:page',
    'docs-zh/:section/:page.html': 'docs-zh/:section/:page',
    'en/docs/:section/:page.md': 'en/docs/:section/:page',
    'en/docs/:section/:page.html': 'en/docs/:section/:page',
    'ja/docs/:section/:page.md': 'ja/docs/:section/:page',
    'ja/docs/:section/:page.html': 'ja/docs/:section/:page',
    'wiki/user-guide/:page.md': 'wiki/user-guide/:page',
    'wiki/user-guide/:page.html': 'wiki/user-guide/:page',
    'en/wiki/user-guide/:page.md': 'en/wiki/user-guide/:page',
    'en/wiki/user-guide/:page.html': 'en/wiki/user-guide/:page',
    'ja/wiki/user-guide/:page.md': 'ja/wiki/user-guide/:page',
    'ja/wiki/user-guide/:page.html': 'ja/wiki/user-guide/:page',
    'example/:page.md': 'example/:page',
    'example/:page.html': 'example/:page',
    'en/example/:page.md': 'en/example/:page',
    'en/example/:page.html': 'en/example/:page',
    'ja/example/:page.md': 'ja/example/:page',
    'ja/example/:page.html': 'ja/example/:page',
    'rules/:page.md': 'rules/:page',
    'rules/:page.html': 'rules/:page',
    'en/rules/:page.md': 'en/rules/:page',
    'en/rules/:page.html': 'en/rules/:page',
    'ja/rules/:page.md': 'ja/rules/:page',
    'ja/rules/:page.html': 'ja/rules/:page',
    'shortcuts/:page.md': 'shortcuts/:page',
    'shortcuts/:page.html': 'shortcuts/:page',
    'en/shortcuts/:page.md': 'en/shortcuts/:page',
    'en/shortcuts/:page.html': 'en/shortcuts/:page',
    'ja/shortcuts/:page.md': 'ja/shortcuts/:page',
    'ja/shortcuts/:page.html': 'ja/shortcuts/:page',
  },
