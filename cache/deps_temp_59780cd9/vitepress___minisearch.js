...
function fuzzySearch(node, query, maxDistance) {
...
const SearchableMap = class _SearchableMap {
  /**
...
const MiniSearch = class _MiniSearch {
  /**
  ...
  static loadJS(js, options) {
    ...
    for (const [term, data] of index) {
      ...
      for (const fieldId of Object.keys(data)) {
        ...
        dataMap.set(Number.parseInt(fieldId, 10), objectToNumericMap(indexEntry))
      }
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const [term, data] of index) {
        ...
        for (const fieldId of Object.keys(data)) {
          ...
          dataMap.set(Number.parseInt(fieldId, 10), yield objectToNumericMapAsync(indexEntry))
        }
        if (++count % 1e3 === 0)
          yield wait(0)
        miniSearch._index.set(term, dataMap)
