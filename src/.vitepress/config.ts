...
export default defineConfig({
  ...
  cleanUrls: true,
  rewrites: {
    'blog/posts/:post': 'blog/posts/:post.html',
    'en/blog/posts/:post': 'en/blog/posts/:post.html',
    'ja/blog/posts/:post': 'ja/blog/posts/:post.html',
    'docs-zh/:section/:page': 'docs-zh/:section/:page.html',
    'en/docs/:section/:page': 'en/docs/:section/:page.html',
    'ja/docs/:section/:page': 'ja/docs/:section/:page.html',
    'wiki/user-guide/:page': 'wiki/user-guide/:page.html',
    'en/wiki/user-guide/:page': 'en/wiki/user-guide/:page.html',
    'ja/wiki/user-guide/:page': 'ja/wiki/user-guide/:page.html',
    'example/:page': 'example/:page.html',
    'en/example/:page': 'en/example/:page.html',
    'ja/example/:page': 'ja/example/:page.html',
    'rules/:page': 'rules/:page.html',
    'en/rules/:page': 'en/rules/:page.html',
    'ja/rules/:page': 'ja/rules/:page.html',
    'shortcuts/:page': 'shortcuts/:page.html',
    'en/shortcuts/:page': 'en/shortcuts/:page.html',
    'ja/shortcuts/:page': 'ja/shortcuts/:page.html',
  },
